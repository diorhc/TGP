...
/*
  ...
  Example:
    node scripts/update-greasyfork-badges.js https://greasyfork.org/ru/scripts/537433-telegram README.md
...
async function updateReadme(readmePath, installCount, version, targetUrl) {
  ...
  const defaultReleaseHref =
    "https://github.com/diorhc/TGP/releases/latest/download/telegram.user.js";
